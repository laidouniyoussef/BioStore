        ...
        <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" method="POST" action="{{route('contact.update',$contact->id)}}" >
            ...
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                    <input value="{{$contact->location}}" type="text" id="location" name="location" required="required" class="form-control ">
                </div>
            </div>
            ...
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                    <input value="{{$contact->email}}" type="email" id="email" name="email" required="required" class="form-control ">
                </div>
            </div>
            ...
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                    <input value="{{$contact->phone}}" type="text" id="phone" name="phone" required="required" class="form-control ">
                </div>
            </div>
