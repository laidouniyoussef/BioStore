<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
    <div class="menu_section">
      ...
      <ul class="nav side-menu">
        ...
        <li><a><i class="fa fa-credit-card"></i>Payments & Customers<span class="fa fa-chevron-down"></span></a>
          <ul class="nav child_menu">
        ...
        <li><a><i class="fa fa-comments"></i> Contacts <span class="fa fa-chevron-down"></span></a>
          <ul class="nav child_menu">
            {{-- <li><a href="{{route('productcategory.index')}}">  </a></li> --}}
        ...
        <li><a><i class="fa fa-home"></i> Home </a></li> --}}
        {{-- <li><a ><i class="fa fa-bolt"></i> Product </a></li> --}}
