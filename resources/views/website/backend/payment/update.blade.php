    ...
    <div class="x_content">
        ...
        <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" method="POST" action="{{route('payment.update',$payment->id)}}" >
            ...
            <div class="item form-group">
                <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name"> Customar Name <span class="required">*</span>
                </label>
            ...
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                    <input value="{{$payment->total}}" type="text" id="total" name="total" required="required" class="form-control ">
                </div>
            </div>
