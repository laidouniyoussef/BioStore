    ...
    <div class="x_content">
        ...
        <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" enctype="multipart/form-data" method="POST" action="{{route('productImage.update',$productImage->id)}}" >
            ...
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                    <input type="text" value="{{$productImage->img_title}}" id="img_title" name="img_title" placeholder="Image Title" required="required" class="form-control ">
                </div>
            </div>

            <div class="item form-group">
                <label class="col-form-label col-md-3 col-sm-3 label-align" for="customFile">Image Upload </label>
                <div class="col-md-6 col-sm-6 ">
                <input type="file" name="img" value="{{$productImage->img}}" class="form-control" id="img" />
                </div>
           </div>
